...
<html>
  <head>
  	<title>Liste des concepte</title>
...
<!-- Start content -->
	...
	<div class="container"> 
		...
		<div class="col-md-9"> <!-- Col 1 -->
			...
			<table id="data_table_chapitre" class="table table-striped table-bordered" cellspacing="0" width="100%">
				<thead>
					<tr>
						<th>N°</th>
						<th>Nom</th>
	...
	<script src="${pageContext.request.contextPath}/js/buttons.print.min.js" type="text/javascript"></script>
  	...
  	<script type="text/javascript">
		...
		function populateClasseDataTable(){
			var tableData = $('#data_table_chapitre').DataTable();
	    ...
	    error: function(response,textStatus ,jqXHR){
  		...
  		//Envoie du formulaire d'ajout de la Classe
  			$("#classe_Add_Form").submit(function(event){ 
				...
				$.ajax({
				   ...
				   complete: function (response,textStatus ,jqXHR) {
						...
						$('#data_table_chapitre').DataTable().rows().remove().draw();
  			...
  			*****************************************************/
  			...
  			$('#data_table_chapitre').on('click','.classe-delete', function(evt){
				$this = $(this);
