		...
		<div class="panel with-nav-tabs panel-primary">
		     <div class="panel-heading">
					<nav class="nav nav-tabs flex-column flex-sm-row"  id="Tab-Content" role="tablist">
					    ...
					    <a id="tab_EmploieDuTemps" href="#content-tab-EmploieDuTemps" class="nav-item nav-link" data-toggle="tab" role="tab" aria-controls="content-tab-EmploieDuTemps" aria-selected="false">
					        <i class="fa fa-calendar-alt mr-2"></i> Emploi  du temps
					    </a>
		    ...
		    <div class="panel-body">
				...
				<div class="tab-content" id="Tab-Content">
					<!-- Content tab 1	: Programme-->
						...
						<div id="content-tab-EmploieDuTemps" class="tab-pane"  role="tabpanel" aria-labelledby="content-tab-EmploieDuTemps">
						   ...
						   <table  id="emploi" class="table table-striped table-bordered rounded mt-5"cellspacing="0" width="100%">
				...
				<tr>
			            ...
			            <td id="Lundi_8H_10H"><span class="text"></span><span class="icons" style="display:none">
			            <i class="fas fa-edit"></i>
			             <i class="fas fa-trash"></i>
			            </span></td>
			            <td id="Lundi_10H_12H"><span class="text"></span><span class="icons" style="display:none">
			            <i class="fas fa-edit"></i>
			             <i class="fas fa-trash"></i>
			            </span></td>
			            <td id="Lundi_14H_16H"><span class="text"></span><span class="icons" style="display:none">
			            <i class="fas fa-edit"></i>
			             <i class="fas fa-trash"></i>
			            </span></td>
			            <td id="Lundi_16H_18H"><span class="text"></span><span class="icons" style="display:none">
			            <i class="fas fa-edit"></i>
			             <i class="fas fa-trash"></i>
			            </span></td>
					</tr>
					<tr>
			            ...
			            <td id="Mardi_8H_10H"><span class="text"></span><span class="icons" style="display:none">
			            <i class="fas fa-edit"></i>
			             <i class="fas fa-trash"></i>
			            </span></td>
			            <td id="Mardi_10H_12H"><span class="text"></span><span class="icons" style="display:none">
			            <i class="fas fa-edit"></i>
			             <i class="fas fa-trash"></i>
			            </span></td>
			            <td id="Mardi_14H_16H"><span class="text"></span><span class="icons" style="display:none">
			            <i class="fas fa-edit"></i>
			             <i class="fas fa-trash"></i>
			            </span></td>
			            <td id="Mardi_16H_18H"><span class="text"></span><span class="icons" style="display:none">
			            <i class="fas fa-edit"></i>
			             <i class="fas fa-trash"></i>
			            </span></td>
					</tr>
					<tr>
						<th class="bg-warning text-center">MER</th>
			             <td id="Mercredi_8H_10H"><span class="text"></span><span class="icons" style="display:none">
			            <i class="fas fa-edit"></i>
			             <i class="fas fa-trash"></i>
			            </span></td>
			            <td id="Mercredi_10H_12H"><span class="text"></span><span class="icons" style="display:none">
			            <i class="fas fa-edit"></i>
			             <i class="fas fa-trash"></i>
			            </span></td>
			            <td id="Mercredi_14H_16H"><span class="text"></span><span class="icons" style="display:none">
			            <i class="fas fa-edit"></i>
			             <i class="fas fa-trash"></i>
			            </span></td>
			            <td id="Mercredi_16H_18H"><span class="text"></span><span class="icons" style="display:none">
			            <i class="fas fa-edit"></i>
			             <i class="fas fa-trash"></i>
			            </span></td>
					</tr>
					<tr>
			            ...
			            <td id="Jeudi_8H_10H"><span class="text"></span><span class="icons" style="display:none">
			            <i class="fas fa-edit"></i>
			             <i class="fas fa-trash"></i>
			            </span></td>
			            <td id="Jeudi_10H_12H"><span class="text"></span><span class="icons" style="display:none">
			            <i class="fas fa-edit"></i>
			             <i class="fas fa-trash"></i>
			            </span></td>
			            <td id="Jeudi_14H_16H"><span class="text"></span><span class="icons" style="display:none">
			            <i class="fas fa-edit"></i>
			             <i class="fas fa-trash"></i>
			            </span></td>
			            <td id="Jeudi_16H_18H"><span class="text"></span><span class="icons" style="display:none">
			            <i class="fas fa-edit"></i>
			             <i class="fas fa-trash"></i>
			            </span></td>
					</tr>
					<tr>
			            ...
			            <td id="Vendredi_8H_10H"><span class="text"></span><span class="icons" style="display:none">
			            <i class="fas fa-edit"></i>
			             <i class="fas fa-trash"></i>
			            </span></td>
			            <td id="Vendredi_10H_12H"><span class="text"></span><span class="icons" style="display:none">
			            <i class="fas fa-edit"></i>
			             <i class="fas fa-trash"></i>
			            </span></td>
			            <td id="Vendredi_14H_16H"><span class="text"></span><span class="icons" style="display:none">
			            <i class="fas fa-edit"></i>
			             <i class="fas fa-trash"></i>
			            </span></td>
			            <td id="Vendredi_16H_18H"><span class="text"></span><span class="icons" style="display:none">
			            <i class="fas fa-edit"></i>
			             <i class="fas fa-trash"></i>
			            </span></td>
					</tr>
					<tr>
			            ...
			            <td id="Samedi_8H_10H"><span class="text"></span><span class="icons" style="display:none">
			            <i class="fas fa-edit"></i>
			             <i class="fas fa-trash"></i>
			            </span></td>
			            <td id="Samedi_10H_12H"><span class="text"></span><span class="icons" style="display:none">
			            <i class="fas fa-edit"></i>
			             <i class="fas fa-trash"></i>
			            </span></td>
			            <td id="Samedi_14H_16H"><span class="text"></span><span class="icons" style="display:none">
			            <i class="fas fa-edit"></i>
			             <i class="fas fa-trash"></i>
			            </span></td>
			            <td id="Samedi_16H_18H"><span class="text"></span><span class="icons" style="display:none">
			            <i class="fas fa-edit"></i>
			             <i class="fas fa-trash"></i>
			            </span></td>
					</tr>
...
function loadPlaning() {
  var classId = '<%= request.getParameter("id")%>';
  $.ajax({
    url: "../Emploi/List?id=" + classId,
    type: "GET",
    dataType: 'json',
    contentType: "application/json; charset=UTF-8",
    success: function(response, textStatus, jqXHR) {
      ...
      for (var i = 0; i < response.length; i++) {
        var m = "#" + response[i].jour.trim() + "_" + response[i].heureDebut.trim() + "_" + response[i].heureFin.trim();
        $(m).html(response[i].matiere.code + "<br>" + response[i].professeur.nom_Fr + "  <br>    " + response[i].salle.code + " <br>  <a class='classe-delete' href='${pageContext.request.contextPath}/E.Professeur/CahierTexte?id=" + classId + "' seanceid=" + response[i].id + "  >  <i class='fa fa-book mr-2' style='color : black'></i></a> <a href='#' class='classe-update'  seanceid=" + response[i].id + " >  <i class='fa fa-user-check' style='color : black'></i></a>");
      }
    },
