...
<!-- Start content -->
	...
	<div class="container"> 
		...
		<div class="col-md-9"> <!-- Col 1 -->
			...
			<table id="data_table_classe" class="table table-striped table-bordered" cellspacing="0" width="100%">
				<thead>
					<tr>
						<th>N°</th>
						<th>Nom</th>
...
<!-- Fin : Moad Loading Ajax -->
	...
	function populateClasseGeneriqueDataTable(){
			var tableData = $('#data_table_classe').DataTable();
			var userId = "${sessionScope.userID}";
			//tableData.DataTable().rows().remove().draw();		// Vider la TableData 
			$.ajax({
				url : "../ProfClasseGeneriqueList?id="+userId,
				type: "GET",
				dataType: 'json',
...
//Chargement des Classes Génériques dans le DataTable ClassesGeneriques:
			...
			**************************************************************************/
			...
			$('#data_table_classe').on('click','.classeGenerique-details', function(evt){
			$this = $(this);
