						...
						var btns='<div class="btn-group dropleft"> \
							  ...
							  <div class="dropdown-menu shadow p-3 mb-5 bg-white rounded" id="dropdownCycle"> \
						        ...
						        <div class="dropdown-divider"></div> \
							  	...
							  	<a class="dropdown-item classeGenerique-programme text-primary" href="${pageContext.request.contextPath}/E.DirecteurEtudes/CahierTexteList?id='+response[i].id+'" cahierTexteID="'+response[i].id+'"><span class="fa fa-cog mr-4"></span>Cahier Texte</a> \
							  </div> \
							</div> ';
						tableData.row.add( [
									response[i].id,
